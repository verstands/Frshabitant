...
const ScriptTable = () => {
  ...
  const getRoles = async () => {
    try {
      ...
      console.log("dddddddddddddddddddddddddddddd", role);
    } catch (error: unknown) {
      console.log(error);
    }
  };
  ...
  const TABLE_HEAD = ["Titre", "Contenu", "Produit", "Campagne", "Action"];
                          ...
                          <td className="p-4">
                            ...
                            >
                              <Link
                                ...
                                className=" inline-block p-2 border border-blue-500 bg-blue-500 rounded-[10px]"
                              >
                                <FaEdit color="white" />
                              </Link>
                              <Link
